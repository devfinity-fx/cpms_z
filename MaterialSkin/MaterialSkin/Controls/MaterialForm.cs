...
namespace MaterialSkin.Controls
{
    public class MaterialForm : Form, IMaterialControl
    {
        ...
        {
            SkinManager.ColorScheme = new ColorScheme(PrimaryColor, DarkPrimaryColor, LightPrimaryColor, AccentColor, TextShade.WHITE);
            base.OnLoad(e);
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //Form title
            g.DrawString(String.Format("  {0}", Text), Font, new SolidBrush(ForeColor), new Rectangle(0, STATUS_BAR_HEIGHT, Width, ACTION_BAR_HEIGHT), new StringFormat { LineAlignment = StringAlignment.Center });
        }
        ...
        private Color _PrimaryColor = Color.FromArgb(55, 71, 79);
        [PropertyTab("PrimaryColor")]
        [DisplayName("PrimaryColor")]
        [Browsable(true)]
        [Description("PrimaryColor of the Form.")]
        [Category("Design")]
        ...
        private Color _LightPrimary = Color.FromArgb(96, 125, 139);
        [PropertyTab("LightPrimaryColor")]
        [DisplayName("LightPrimaryColor")]
        [Browsable(true)]
        [Description("Light Primary Color of the Form.")]
        [Category("Design")]
        [DefaultValue(typeof(Color), "96,125,139")]
        ...
        private Color _AccentColor = Color.FromArgb(64, 196, 255);
        [PropertyTab("AccentColor")]
        [DisplayName("AccentColor")]
        [Browsable(true)]
        [Description("Accent Color of the Form.")]
        [Category("Design")]
        [DefaultValue(typeof(Color), "64,196,255")]
        ...
        private Color _DarkPrimary = Color.FromArgb(38, 50, 56);
        [PropertyTab("DarkPrimaryColor")]
        [DisplayName("DarkPrimaryColor")]
        [Browsable(true)]
        [Description("Dark Primary Color of the Form.")]
        [Category("Design")]
        [DefaultValue(typeof(Color), "38,50,56")]
